namespace SoftwareReliStat
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			загрузитьФайлCSVToolStripMenuItem = new ToolStripMenuItem();
			...
			// toolStrip
			// 
			toolStrip.BackColor = Color.LightSteelBlue;
			toolStrip.ImageScalingSize = new Size(30, 30);
			toolStrip.Items.AddRange(new ToolStripItem[] { toolStripDropDownButton1, toolStripSeparator1, toolStripButton1, toolStripSeparator2, toolStripButton2 });
			toolStrip.Location = new Point(0, 0);
			toolStrip.Name = "toolStrip";
			toolStrip.Padding = new Padding(0);
			toolStrip.Size = new Size(522, 37);
			...
			toolStripDropDownButton1.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
			toolStripDropDownButton1.Image = (Image)resources.GetObject("toolStripDropDownButton1.Image");
			toolStripDropDownButton1.ImageTransparentColor = Color.Magenta;
			toolStripDropDownButton1.Name = "toolStripDropDownButton1";
			toolStripDropDownButton1.Size = new Size(67, 34);
			...
			сохранитьРезультатРасчетаToolStripMenuItem.Size = new Size(296, 26);
			...
			загрузитьФайлCSVToolStripMenuItem.Size = new Size(296, 26);
			...
			// toolStripButton1
			// 
			toolStripButton1.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
			toolStripButton1.Image = (Image)resources.GetObject("toolStripButton1.Image");
			toolStripButton1.ImageTransparentColor = Color.Magenta;
			toolStripButton1.Name = "toolStripButton1";
			toolStripButton1.Size = new Size(115, 34);
			toolStripButton1.Text = "ОИК СК-11";
			...
			// toolStripButton2
			// 
			toolStripButton2.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
			toolStripButton2.Image = (Image)resources.GetObject("toolStripButton2.Image");
			toolStripButton2.ImageTransparentColor = Color.Magenta;
			toolStripButton2.Name = "toolStripButton2";
			toolStripButton2.Size = new Size(133, 34);
			toolStripButton2.Text = "База данных";
			...
			groupBox1.Size = new Size(498, 168);
			...
			guna2ComboBox2.Location = new Point(264, 53);
			...
			label1.TabIndex = 1;
			label1.Text = "Объединенная энергосистема";
			// 
			// guna2ComboBox1
			// 
			...
			groupBox2.Controls.Add(guna2ComboBox4);
			...
			groupBox2.Size = new Size(499, 169);
			...
			label9.Location = new Point(265, 101);
			label9.Name = "label9";
			...
			label8.TabIndex = 7;
			label8.Text = "Начальная метка времени";
			// 
			// guna2ComboBox4
			// 
			...
			label7.Location = new Point(265, 28);
			label7.Name = "label7";
			label7.Size = new Size(189, 20);
			label7.TabIndex = 2;
			label7.Text = "Конечная метка времени";
			// 
			// label6
			// 
			...
			guna2TextBox1.Location = new Point(6, 125);
			...
			guna2Button3.FillColor = Color.LightSteelBlue;
			guna2Button3.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
			...
			guna2Button2.FillColor = Color.LightSteelBlue;
			guna2Button2.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
			...
			guna2Button1.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
		...
		private ToolStripMenuItem сохранитьРезультатРасчетаToolStripMenuItem;
		private ToolStripMenuItem загрузитьФайлCSVToolStripMenuItem;
